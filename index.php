...
<body>
 ...
 <header class="jumbotron back-image" style="background-image:url(images/water.jpg);">
 ...
 <div class="container">
  <div class="jumbotron">
   ...
   <p>
   OSMS Services is Dhoraji's leading chain of multi-brand Water purifier resell and service workshops offering wide array of services. We focus on enhancing your uses experience by offering world-class Water treatment plant maintenance services. Our sole mission is “To provide water-treatment care services to keep your drinking water fit and healthy”.
    
    With well-equipped Electronic water-plant service centres and fully trained mechanics, we provide quality services with excellent packages that are designed to offer you great savings.
    
    Our state-of-art workshops are conveniently located in many
    cities across the Rajkot. Now you can book your service online by doing Registration.
    </p>
  </div>
 ...
 <div class="container" id="Contact">
  ...
  <div class="row">
   ...
   <div class="col-md-4 text-center"> <!-- Start 2nd Column -->
    ...
    Avasar Marketing,<br>
    Bavla chowk, near garden<br>
    gujarat - 360410<br>
    Phone: +9979580030<br>
    <a href="#" target="_blank">www.avasarMarketing.com</a><br>
    <br> <br>
    <strong>Branch:</strong><br>
    Avasar Marketing,<br>
    sardar chowk, jetpur<br>
    jetpur - 360370<br>
    Phone: +9979580030<br>
    <a href="#" target="_blank">www.AvasarMarketing.com</a><br>    
   </div> <!-- End 2nd Column -->
  ...
  <div class="container">
   <div class="row py-3">
    ...
    <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
     <small>Designed by Ruchit &copy; 2024</small>
